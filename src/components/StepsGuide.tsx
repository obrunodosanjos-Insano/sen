...
export const StepsGuide: React.FC = () => {
  ...
  return (
    <section id="como-participar" className="py-16 sm:py-24 border-b border-slate-200 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-10">
          {steps.map((step, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-white rounded-none border border-slate-200 p-6 sm:p-7 shadow-xs hover:border-slate-300 transition-all flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-xs font-extrabold px-2.5 py-1 rounded-none bg-slate-100 text-slate-900 uppercase tracking-wider">
                      Passo {step.num}
                    </span>
        ...
        <div className="rounded-none border border-slate-200 bg-slate-50 text-slate-900 p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xs">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-3 rounded-none bg-slate-900 text-white hover:bg-black font-bold text-sm shadow-xs transition-all whitespace-nowrap flex-shrink-0"
          >
