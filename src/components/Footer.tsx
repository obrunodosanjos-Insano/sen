...
export const Footer: React.FC = () => {
  return (
    <footer className="border-t border-slate-200 bg-slate-50 text-slate-600 py-14 text-sm">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-12 border-b border-slate-200">
          {/* Brand Col */}
          <div className="md:col-span-1 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-none bg-slate-900 flex items-center justify-center p-1.5 shadow-xs">
                <FirstLogo className="w-full h-full text-white" />
              </div>
              <div>
                <span className="font-extrabold text-slate-900 tracking-tight font-display text-base block">
                  FIRST® Inspires
                </span>
          ...
          {/* Programs Col */}
          <div>
            <h4 className="font-bold text-slate-900 text-xs uppercase tracking-wider mb-4 font-display">
              Programas Oficiais
            </h4>
            <ul className="space-y-2.5 text-xs text-slate-600">
              <li>
                <a href="#fll" className="hover:text-black transition-colors flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-none bg-slate-900" />
                  <span>FIRST® LEGO® League (FLL)</span>
                </a>
              </li>
              <li>
                <a href="#ftc" className="hover:text-black transition-colors flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-none bg-slate-700" />
                  <span>FIRST® Tech Challenge (FTC)</span>
                </a>
              </li>
              <li>
                <a href="#frc" className="hover:text-black transition-colors flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-none bg-slate-500" />
                  <span>FIRST® Robotics Competition (FRC)</span>
                </a>
              </li>
              <li>
                <a href="#comparativo" className="hover:text-black transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-slate-600">
              ...
              <li>
                <a href="#impacto" className="hover:text-black transition-colors">
                  Bolsas Universitárias ($80M+)
                </a>
              </li>
              <li>
                <a href="#como-participar" className="hover:text-black transition-colors">
                  Guia para Formar Equipe
                </a>
              </li>
              <li>
                <a href="#galeria" className="hover:text-black font-semibold transition-colors">
