...
export const ImpactSection: React.FC = () => {
  return (
    <section id="impacto" className="py-16 sm:py-24 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 transition-colors">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {/* Card 1: Bolsas */}
          <div className="bg-white dark:bg-slate-800/80 rounded-none border border-slate-200 dark:border-slate-700 p-6 sm:p-7 shadow-xs flex flex-col justify-between hover:border-slate-300 dark:hover:border-slate-600 transition-all">
            <div>
              <div className="w-12 h-12 rounded-none bg-slate-50 dark:bg-slate-700 text-slate-800 dark:text-slate-200 border border-slate-200 dark:border-slate-600 flex items-center justify-center mb-4">
                <GraduationCap className="w-6 h-6" />
              </div>
              <div className="text-2xl font-black text-slate-900 dark:text-white mb-1 font-display">+$80 Milhões</div>
            ...
            <div className="pt-4 border-t border-slate-100 dark:border-slate-700 mt-6 text-xs text-slate-500 dark:text-slate-400 font-medium">
          ...
          <div className="bg-white dark:bg-slate-800/80 rounded-none border border-slate-200 dark:border-slate-700 p-6 sm:p-7 shadow-xs flex flex-col justify-between hover:border-slate-300 dark:hover:border-slate-600 transition-all">
            <div>
              ...
              <div className="text-2xl font-black text-slate-900 dark:text-white mb-1 font-display">2x Mais Chances</div>
              <div className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-3">
          ...
          <div className="bg-white dark:bg-slate-800/80 rounded-none border border-slate-200 dark:border-slate-700 p-6 sm:p-7 shadow-xs flex flex-col justify-between hover:border-slate-300 dark:hover:border-slate-600 transition-all">
            <div>
              ...
              <div className="text-2xl font-black text-slate-900 dark:text-white mb-1 font-display">Habilidades Reais</div>
              <div className="text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-3">
        ...
        <div className="bg-slate-50 dark:bg-slate-800/60 rounded-none border border-slate-200 dark:border-slate-700 p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xs">
          <div className="space-y-1 text-center md:text-left">
            <h3 className="text-lg font-bold text-slate-900 dark:text-white font-display">
              Apoiadores Globais e no Brasil
            </h3>
            <p className="text-sm text-slate-600 dark:text-slate-300 max-w-2xl">
              No Brasil, os programas contam com a estrutura da CNI, <strong className="text-slate-900 dark:text-white">SESI e SENAI</strong>, além do patrocínio e mentoria de indústrias nacionais e multinacionais de ponta.
            </p>
          </div>
          <a
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-none bg-slate-900 hover:bg-black dark:bg-white dark:hover:bg-slate-100 text-white dark:text-slate-900 text-xs font-bold transition-colors whitespace-nowrap shadow-xs"
          >
