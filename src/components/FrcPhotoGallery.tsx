...
const PRESET_FRC_PHOTOS: FrcPhoto[] = [
  {
    ...
    title: 'Integração Elétrica e Módulos roboRIO 2.0 & CAN Bus',
    category: 'Robô & Mecânica',
    teamNumber: '#1156 Under Control',
    seasonYear: 'Temporada Oficial',
    timestamp: 'Bancada de Engenharia',
    isPreset: true,
  },
  {
    id: 'frc_preset_2',
    dataUrl: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=1200&q=80',
    title: 'Módulo de Tração Swerve Drive SDS MK4i com Motores Brushless',
    category: 'Swerve Drive',
    teamNumber: '#1772 Brazilian Trail Blazers',
    seasonYear: 'Temporada Oficial',
    timestamp: 'Usinagem CNC & Montagem',
    isPreset: true,
  },
  {
    id: 'frc_preset_3',
    dataUrl: 'https://images.unsplash.com/photo-1563770660941-20978e870e26?auto=format&fit=crop&w=1200&q=80',
    title: 'Alianças 3v3 em Disputa na Arena do Regional Brasil (Brasília)',
    category: 'Partidas na Arena',
    teamNumber: '#9085 Megazord SESI SENAI',
    seasonYear: 'Playoffs Regionais',
    timestamp: 'Festival SESI de Robótica',
    isPreset: true,
  },
  {
    id: 'frc_preset_4',
    dataUrl: 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?auto=format&fit=crop&w=1200&q=80',
    title: 'Manutenção Rápida e Telemetria no Pit Oficial do Evento',
    category: 'Área de Pits',
    teamNumber: '#5800 Magic Island Robotics',
    seasonYear: 'Regional Brasil',
    timestamp: 'Área Oficial de Boxes',
    isPreset: true,
  },
];
